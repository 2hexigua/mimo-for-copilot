...
const zh: Translations = {
	...
	// Thinking — MiMo supports enabled/disabled only
	'status.thinking': '思考模式',
	'thinking.enabled': '启用',
	'thinking.enabled.desc': '启用深度思考',
	'thinking.disabled': '停用',
	'thinking.disabled.desc': '停用思考，响应更快',
	...
	'notice.toolDrift':
		'⚠️ 工具列表不稳定，缓存命中率可能下降。[了解更多](https://github.com/2hexigua/mimo-for-copilot/blob/main/docs/notices/tool-drift.zh.md)',
...
const en: Translations = {
	// Model descriptions
	'model.5-pro.detail': 'Most capable reasoning model',
	'model.5.detail': 'Balanced general-purpose model',
	'model.flash.detail': 'Fast, efficient model',
	...
	'thinking.enabled.desc': 'Enable deep thinking',
	'thinking.disabled': 'Disabled',
	'thinking.disabled.desc': 'Disable thinking for faster responses',
	...
	'notice.toolDrift':
		'⚠️ Tool list is unstable; cache hit rate may drop. [Learn more](https://github.com/2hexigua/mimo-for-copilot/blob/main/docs/notices/tool-drift.en.md)',
